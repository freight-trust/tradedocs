 ...
 * </p>
 * <ul>
 *   <li>{@link gov.dhs.cbp.dis.impl.EntryTypeImpl#getEntryNumber <em>Entry Number</em>}</li>
 *   <li>{@link gov.dhs.cbp.dis.impl.EntryTypeImpl#getFiler <em>Filer</em>}</li>
 *   <li>{@link gov.dhs.cbp.dis.impl.EntryTypeImpl#getEntryLineNumber <em>Entry Line Number</em>}</li>
 *   <li>{@link gov.dhs.cbp.dis.impl.EntryTypeImpl#getReferenceNumber <em>Reference Number</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EntryTypeImpl extends MinimalEObjectImpl.Container implements EntryType {
	...
	protected EClass eStaticClass() {
		return DisPackage.Literals.ENTRY_TYPE;
	}
	...
	public void setEntryNumber(String newEntryNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DisPackage.ENTRY_TYPE__ENTRY_NUMBER, oldEntryNumber, entryNumber));
	}
	...
	public void setFiler(String newFiler) {
		...
		filer = newFiler;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DisPackage.ENTRY_TYPE__FILER, oldFiler, filer));
	}
	...
	public void setEntryLineNumber(String newEntryLineNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DisPackage.ENTRY_TYPE__ENTRY_LINE_NUMBER, oldEntryLineNumber, entryLineNumber));
	}
	...
	public void setReferenceNumber(String newReferenceNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DisPackage.ENTRY_TYPE__REFERENCE_NUMBER, oldReferenceNumber, referenceNumber));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DisPackage.ENTRY_TYPE__ENTRY_NUMBER:
				return getEntryNumber();
			case DisPackage.ENTRY_TYPE__FILER:
				return getFiler();
			case DisPackage.ENTRY_TYPE__ENTRY_LINE_NUMBER:
				return getEntryLineNumber();
			case DisPackage.ENTRY_TYPE__REFERENCE_NUMBER:
